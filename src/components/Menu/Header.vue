      ...
      <el-dialog
        ...
        <el-form :model="form" :rules="rules" style="text-align: left" ref="form" label-width="120px">
          ...
          <el-form-item label="新密码：" prop="password_new">
            <el-input v-model="form.password_new" type="password" style="width: 200px"></el-input>
          </el-form-item>
          <el-form-item label="确认密码：" prop="password_new_sure">
            <el-input v-model="form.password_new_sure" type="password" style="width: 200px"></el-input>
            <!-- 待添加二次确认密码验证 -->
    ...
    formSubmit (formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          ...
          if (res.data.result === 0) {
            this.$handleSuccessMessage('修改密码成功')
